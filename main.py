...
gym_envs = {
    # ENV_KEY: [env_id, state_dim, action_dim, intial warmup steps to generate random seed]
    ...
    '14': ['Investor1_1x', 2, 1, 1e3], '15': ['Investor1_2x', 3, 2, 1e3], '16': ['Investor1_10x', 11, 10, 1e3],
    # investor 2: portfolio of one, two and ten assets
    '17': ['Investor2_1x', 2, 2, 1e3], '18': ['Investor2_2x', 3, 3, 1e3], '19': ['Investor2_10x', 11, 11, 1e3],
    # investor 3: portfolio of one, two and ten assets
    '20': ['Investor3_1x', 2, 3, 1e3], '21': ['Investor3_2x', 3, 4, 1e3], '22': ['Investor3_10x', 11, 12, 1e3],

    # assets following dice roll
    # investor 1: portfolio of one and ten assets 
    '23': ['Investor1_Dice_1x', 2, 1, 3e3], '24': ['Investor1_Dice_10x', 11, 10, 1e3],
    # investor 3: portfolio of one and ten assets 
    '25': ['Investor1_Dice_3x', 2, 1, 1e3], '26': ['Investor3_Dice_10x', 11, 10, 1e3]
    }

inputs_dict = {
    # execution parameters
    'n_trials': 2,                              # number of total unique training trials
    'n_cumsteps': 2e4,                          # maximum cumulative steps per trial (must be greater than warmup)
