...
class GBM_D_n1_InvA(gym.Env):
    ...
    def __init__(self):
        ...
        """
        super(GBM_D_n1_InvA, self).__init__()
    ...
    def step(self, action: np.ndarray) -> Tuple[np.ndarray, float, bool, np.ndarray]:
        ...
        dp = np.exp(np.random.normal(loc=LOG_MEAN, scale=VOL, size=None))
...
class GBM_D_n2_InvA(gym.Env):
    """
    OpenAI gym environment for determining the optimal leverage at each time step 
    for the GBM approximation of the S&P500 index for a portfoilio of 
    ...
    def __init__(self):
        ...
        Intialise class varaibles by creating state-action space and reward range.
        """
        super(GBM_D_n2_InvA, self).__init__()
    ...
    def step(self, action: np.ndarray) -> Tuple[np.ndarray, float, bool, np.ndarray]:
        ...
        # sample new price % change factor
        dp = np.exp(np.random.normal(loc=LOG_MEAN, scale=VOL, size=2))
        ...
        # obtain next state
        self.asset0, self.asset1 = initial_asset0 * dp[0], initial_asset1 * dp[1]
...
class GBM_D_n10_InvA(gym.Env):
    """
    OpenAI gym environment for determining the optimal leverages at each time 
    step for the GBM approximation of the S&P500 index for a portfoilio of 
    ...
    def __init__(self):
        ...
        Intialise class varaibles by creating state-action space and reward range.
        """
        super(GBM_D_n10_InvA, self).__init__()
    ...
    def step(self, action: np.ndarray) -> Tuple[np.ndarray, float, bool, np.ndarray]:
        ...
        # sample new price % change factor
        dp = np.exp(np.random.normal(loc=LOG_MEAN, scale=VOL, size=10))
        ...
        # obtain next state
        self.asset0, self.asset1 = initial_asset0 * dp[0], initial_asset1 * dp[1]
        self.asset2, self.asset3 = initial_asset2 * dp[2], initial_asset3 * dp[3]
        self.asset4, self.asset5 = initial_asset4 * dp[4], initial_asset5 * dp[5]
        self.asset6, self.asset7 = initial_asset6 * dp[6], initial_asset7 * dp[7]
        self.asset8, self.asset9 = initial_asset8 * dp[8], initial_asset9 * dp[9]
...
class GBM_D_n1_InvB(gym.Env):
    """
    OpenAI gym environment for determining the optimal [leverage, stop-loss] at each 
    time step for the GBM approximation of the S&P500 index.
    ...
    def __init__(self):
        ...
        Intialise class varaibles by creating state-action space and reward range.
        """
        super(GBM_D_n1_InvB, self).__init__()
...
class GBM_D_n2_InvB(gym.Env):
    """
    OpenAI gym environment for determining the optimal [leverage, stop-loss] at each 
    time step for the GBM approximation of the S&P500 index for a portfoilio of 
    two identical assets.
    ...
    def __init__(self):
        ...
        Intialise class varaibles by creating state-action space and reward range.
        """
        super(GBM_D_n2_InvB, self).__init__()
...
class GBM_D_n10_InvB(gym.Env):
    """
    OpenAI gym environment for determining the optimal [leverage, stop-loss]
    at each time step for the GBM approximation of the S&P500 index for a 
    ...
    def __init__(self):
        ...
        Intialise class varaibles by creating state-action space and reward range.
        """
        super(GBM_D_n10_InvB, self).__init__()
...
class GBM_D_n1_InvC(gym.Env):
    ...
    def __init__(self):
        ...
        Intialise class varaibles by creating state-action space and reward range.
        """
        super(GBM_D_n1_InvC, self).__init__()
...
class GBM_D_n2_InvC(gym.Env):
    """
    OpenAI gym environment for determining the optimal [leverage, stop-loss, 
    retention ratio] at each time step for the GBM approximation of the S&P500 
    index for a portfoilio of two identical assets.
    ...
    def __init__(self):
        ...
        Intialise class varaibles by creating state-action space and reward range.
        """
        super(GBM_D_n2_InvC, self).__init__()
...
class GBM_D_n10_InvC(gym.Env):
    """
    OpenAI gym environment for determining the optimal [leverage, stop-loss, 
    retention ratio] at each time step for the GBM approximation of the S&P500 
    index for a portfoilio of ten identical assets.
    ...
    def __init__(self):
        ...
        Intialise class varaibles by creating state-action space and reward range.
        """
        super(GBM_D_n10_InvC, self).__init__()
